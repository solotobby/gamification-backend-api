...
class PurgeDeletedUsers extends Command
{
    ...
    public function handle(): int
    {
            ...
            foreach ($users as $user) {
                ...
                try {
                    DB::transaction(function () use ($user) {
                        // Delete related virtual accounts and tokens if any
        ...
        if ($dryRun) {
            ...
            if (function_exists('teamsInfo') && $purgedCount > 0) {
                teamsInfo("PurgeDeletedUsers: Permanently purged {$purgedCount} user account(s) past 60-day retention window.", [
